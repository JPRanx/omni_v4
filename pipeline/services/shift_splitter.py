...
class ShiftSplitter:
    ...
    def split_day(
        ...
        void_metrics: Optional[VoidMetricsDTO] = None
    ) -> ShiftMetricsDTO:
        """
        ...
        Args:
            ...
            void_metrics: Optional void transaction metrics
    ...
    def _split_by_order_timestamps(
        ...
        # Get void counts from extracted void metrics
        morning_voids = void_metrics.morning_void_count if void_metrics else 0
        evening_voids = void_metrics.evening_void_count if void_metrics else 0
